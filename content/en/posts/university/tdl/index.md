...
The translator takes a source file written in the [Boreal Language](https://dlsiis.fi.upm.es/traductores/IntroBoreal.html), previously validated by the processor, and generates an `.ens` file withe the **object code** of the program, written in the [ENS2001 Language](https://dlsiis.fi.upm.es/traductores/Documentos/ENS2001.pdf).
...
First, we need to compile the project. You can check how to do this in the [Additional Information](#additional-information) section.

Once the `.ens` file (named `codobj.ens`) is generated, we can proceed to execute it with the assembler.
